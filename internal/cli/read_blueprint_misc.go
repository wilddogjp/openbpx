...
func runBlueprint(args []string, stdout, stderr io.Writer) int {
	return dispatchSubcommand(
		...
		stdout,
		stderr,
		"usage: bpx blueprint <info|widget-read|widget-init|widget-parent-class|widget-add|widget-remove|widget-write|bytecode|disasm|trace|call-args|refs|search|scan-functions|infer-pack> ...",
		"unknown blueprint command: %s\n",
		subcommandSpec{Name: "info", Run: runBlueprintInfo},
		subcommandSpec{Name: "widget-read", Run: runBlueprintWidgetRead},
		subcommandSpec{Name: "widget-init", Run: runBlueprintWidgetInit},
		subcommandSpec{Name: "widget-parent-class", Run: runBlueprintWidgetParentClass},
		subcommandSpec{Name: "widget-add", Run: runBlueprintWidgetAdd},
		subcommandSpec{Name: "widget-remove", Run: runBlueprintWidgetRemove},
		subcommandSpec{Name: "widget-write", Run: runBlueprintWidgetWrite},
